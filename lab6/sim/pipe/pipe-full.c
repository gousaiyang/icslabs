...
int gen_f_pc()
{
    return ((((ex_mem_curr->icode) == (I_JMP)) & !(ex_mem_curr->takebranch)
      ...
      (mem_wb_curr->valm) : (((id_ex_curr->icode) == (I_RET)) & (
          (ex_mem_curr->icode) == (I_PUSHL))) ? (ex_mem_curr->vala) : 
      (pc_curr->pc));
}
...
{
    return ((((id_ex_curr->icode) == (I_RMMOVL) || (id_ex_curr->icode) == 
          (I_PUSHL)) & ((id_ex_curr->srca) == (ex_mem_curr->destm))) ? 
...
int gen_F_stall()
{
    return (((((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
            ...
            (id_ex_curr->destm) == (id_ex_next->srcb))) & !(((
              ...
              (I_PUSHL)) & ((id_ex_next->srca) == (id_ex_curr->destm))) & (
            (id_ex_next->srcb) != (id_ex_curr->destm)))) | (((I_RET) == 
          (if_id_curr->icode) || (I_RET) == (id_ex_curr->icode) || (I_RET)
           == (ex_mem_curr->icode)) & !((((id_ex_curr->icode) == (I_RET))
             & ((ex_mem_curr->icode) == (I_PUSHL))) | ((
...
int gen_D_bubble()
{
    return ((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch))
       | ((!(((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
            ...
            (I_RET) == (ex_mem_curr->icode))) & !((((id_ex_curr->icode) == 
              (I_RET)) & ((ex_mem_curr->icode) == (I_PUSHL))) | ((
              (ex_mem_curr->icode) == (I_RET)) & ((mem_wb_curr->icode) == 
              (I_PUSHL))))));
}
